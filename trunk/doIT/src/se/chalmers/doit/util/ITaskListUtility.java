...
public interface ITaskListUtility {
	...
	/**
	 * Sorts the provided task using primary, secondary and tertiary sorting strategies.
	 * @param list - list to sort
	 * @param primary - primary sorting strategy
	 * @param secondary - secondary sorting strategy
	 * @param tertiary - tertiary sorting strategy
