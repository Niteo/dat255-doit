...
public class DataSQLTest extends AndroidTestCase {
	...
	public void testGetAllLists() {
		...
		assertTrue(_containsEqualList(db.getAllLists(), new TaskCollection(
				"TESTNAME")));
		cv.clear();
	...
	public void testAddList() {
		...
		db.addList(list);
		assertTrue(db.getAllLists().size() == 1);
		assertTrue(_containsEqualList(db.getAllLists(), list));
		db.addList(list2);
		assertTrue(db.getAllLists().size() == 2);
		assertTrue(_containsEqualList(db.getAllLists(), list));
		assertTrue(_containsEqualList(db.getAllLists(), list2));
	}
	...
	public void testAddLists() {
		...
		assertTrue(_containsEqualList(db.getAllLists(), list));
		assertTrue(_containsEqualList(db.getAllLists(), list2));
		assertTrue(_containsEqualList(db.getAllLists(), list3));
		assertTrue(_containsEqualList(db.getAllLists(), list4));
	}

	public void testAddTask() {
		Task task = new Task("TASK", "DESC", new Priority((byte)3), new Date(7), new Date(3), 5, false);
		Task task2 = new Task("TASK2", "DESC2", new Priority((byte)6), new Date(2), new Date(23), 16, true);
		db.addTask(task, 0);
		assertTrue(db.getAllTasks().size() == 1);
		assertTrue(_containsEqualTask(db.getAllTasks(), task));
		assertFalse(_containsEqualTask(db.getAllTasks(), task2));
		db.addTask(task2, 0);
		assertTrue(db.getAllTasks().size() == 2);
		assertTrue(_containsEqualTask(db.getAllTasks(), task));
		assertTrue(_containsEqualTask(db.getAllTasks(), task2));
	}
	...
	public void testEditList() {
		...
		assertTrue(db.getAllLists().size() == 1);
		assertTrue(_containsEqualList(db.getAllLists(), list2));
		assertFalse(_containsEqualList(db.getAllLists(), list));

		assertTrue(db.editList(1, list));
		assertTrue(db.getAllLists().size() == 1);
		assertTrue(_containsEqualList(db.getAllLists(), list));
		assertFalse(_containsEqualList(db.getAllLists(), list2));
	}
	...
	public void testGetAllTasks() {
		...
		ret.put(SQLConstants.TASK_REMINDERDATE, task.getReminderDate().getTime());
		...
		ret.put(SQLConstants.TASK_REMINDERDATE, task2.getReminderDate().getTime());
	...
	public void testRemoveList() {
		...
		assertFalse(_containsEqualList(db.getAllLists(), list));
		assertTrue(_containsEqualList(db.getAllLists(), list2));
		assertFalse(_containsEqualList(db.getAllLists(), list3));
		assertTrue(_containsEqualList(db.getAllLists(), list4));
	}
	...
	public void testRemoveLists() {
		...
		assertFalse(_containsEqualList(db.getAllLists(), list2));
		assertFalse(_containsEqualList(db.getAllLists(), list3));
		assertFalse(_containsEqualList(db.getAllLists(), list4));
	}

	public void testRemoveTask() {
		Task task = new Task("TASK", "DESC", new Priority((byte)3), new Date(7), new Date(3), 5, false);
		Task task2 = new Task("TASK2", "DESC2", new Priority((byte)6), new Date(2), new Date(23), 16, true);
		Task task3 = new Task("TASK3", "DESC3", new Priority((byte)3), new Date(7), new Date(3), 5, false);
		Task task4 = new Task("TASK4", "DESC4", new Priority((byte)6), new Date(2), new Date(23), 16, true);
		
		db.addTasks(new Task[]{task, task2, task3, task4}, 1);
		
		db.removeTask(1);
		assertTrue(db.getAllTasks().size() == 3);
		assertFalse(_containsEqualTask(db.getAllTasks(), task));
		assertTrue(_containsEqualTask(db.getAllTasks(), task2));
		assertTrue(_containsEqualTask(db.getAllTasks(), task3));
		assertTrue(_containsEqualTask(db.getAllTasks(), task4));
		
		db.removeTask(3);
		assertTrue(db.getAllTasks().size() == 2);
		assertFalse(_containsEqualTask(db.getAllTasks(), task));
		assertTrue(_containsEqualTask(db.getAllTasks(), task2));
		assertFalse(_containsEqualTask(db.getAllTasks(), task3));
		assertTrue(_containsEqualTask(db.getAllTasks(), task4));
	}
	...
	public void testRemoveTasks() {
		...
		assertFalse(_containsEqualTask(db.getAllTasks(), task2));
		assertFalse(_containsEqualTask(db.getAllTasks(), task3));
		assertFalse(_containsEqualTask(db.getAllTasks(), task4));
	}
