...
ant debug
$SDKDIR/platform-tools/adb install bin/MainActivity-debug.apk
#TODO: Code for running tests
#$SDKDIR/platform-tools/adb shell am instrument -w se.chalmers.doit.test.core/android.test.InstrumentationTestRunner
