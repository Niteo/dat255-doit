...
public class TaskTest extends AndroidTestCase {
	...
	public void testTaskStringStringIPriorityDateDateIntBoolean() {
		new Task("Name", "Description", new Priority((byte) 1), new Date(1),
				new Date(2), 0, false);
	}
...
//	}
	...
	public void testGetDueDate() {
		...
		Task t = new Task("Name", "Description", new Priority((byte) 1), date1,
				new Date(2), 5, false);
		assertTrue(t.getDueDate().equals(date1));

		t = new Task("Name", "Description", new Priority((byte) 1), date2,
				new Date(2), 13337, false);
